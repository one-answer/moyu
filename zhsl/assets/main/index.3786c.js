    ...
    MainGameJS: [function (e, t) {
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            judgeCurPlatform: function () {
                ...
                var e, t, a, i, o, n, s,
                    c = (e = navigator.userAgent, t = /(?:Windows Phone)/.test(e), a = /(?:SymbianOS)/.test(e) || t, i = /(?:Android)/.test(e), o = /(?:Firefox)/.test(e), /(?:Chrome|CriOS)/.test(e), {
            ...
            onLoad: function () {
                ...
                // 防止无输入
                // if(level == undefined || level == null || level == '' || level < 1 || level > 9) 	level = 1;

                this.playerNode.typeID = level,
                    this.createMap(), this.maxCameraMovePosX = Math.abs(this.BGArr[0][this.BGNum - 1].x) - this.gameWidth, this.maxCameraMovePosY = Math.abs(this.BGArr[0][this.BGNum - 1].y) - this.gameHeight / 2;
            ...
            createLizi: function (e, t) {
                ...
                for (var n = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio, c = s.getRandomNum(15, 25, !0), r = s.getRandomNum(0, .05, !1), h = 0; h < c; h++) {
                    ...
                    s.getRandomNum(30, 180, !0), m.runAction(cc.sequence(cc.delayTime(r), cc.spawn(cc.moveTo(f, p).easing(cc.easeQuarticActionOut()), cc.scaleTo(f, u, u)), cc.fadeOut(.5), cc.callFunc(function () {
                    }, this), cc.removeSelf()))
                }
            ...
            CreatePanLong: function () {
                ...
                this.node.addChild(l, 30), l.scaleX = 0, l.scaleY = 0, l.setPosition(this.stoneNode.position), t.runAction(cc.sequence(cc.spawn(cc.moveTo(.5, c), cc.fadeIn(.3), cc.callFunc(function () {
                    ...
                    t.scaleX = .7 * this.SizeScale, t.scaleY = .7 * this.SizeScale, this.node.addChild(t, 5e3), t.opacity = 0, t.setPosition(cc.v2(-this.gameWidth / 2 + this.gameWidth / 8, this.gameHeight / 2 - this.gameWidth / 8)), t.runAction(cc.fadeIn(.3)), t.on(cc.Node.EventType.TOUCH_START, function () {
                    ...
                    this.node.addChild(n, 5e3), n.scaleX = 0, n.scaleY = 0, n.setPosition(cc.v2(0, -this.stoneNode.y - 200 * this.Hscale)), n.runAction(cc.scaleTo(.5, .6 * this.SizeScale, .6 * this.SizeScale).easing(cc.easeBackOut()), cc.callFunc(function () {
                    }, this));
                    ...
                    c.setPosition(cc.v2(r.x, r.y - 50 * this.SizeScale)), c.runAction(cc.sequence(cc.spawn(cc.fadeIn(.3), cc.moveTo(.3, r)), cc.callFunc(function () {
                    ...
                    }, e))), e.scheduleOnce(function () {
                        l.runAction(cc.sequence(cc.rotateBy(10, 360), cc.callFunc(function () {
                        }, e)).repeatForever())
                    }, .5), t.runAction(cc.sequence(cc.spawn(cc.scaleTo(.5, .9 * e.SizeScale, .9 * e.SizeScale), cc.moveTo(.5, -50 * e.SizeScale, e.gameHeight / 6 - 370 * e.SizeScale).easing(cc.easeBackOut())), cc.callFunc(function () {
                    }, e)))
                    ...
                    }, e)).repeatForever()), a.runAction(cc.sequence(cc.rotateBy(1, -10), cc.callFunc(function () {
                    }, e)).repeatForever()), i.runAction(cc.sequence(cc.rotateBy(.5, 10), cc.callFunc(function () {
                    }, e)).repeatForever())
        ...
        var a = e("HttpManagerJs"),
            ...
            c = {
                ...
                getHttpGameId: function () {
                    ...
                    -1 == e.search("/game/") ? this.moreGameUrl = t + a : this.moreGameUrl = t + r, console.log("moreGame", this.moreGameUrl)
                },
        ...
        cc.Class({
            ...
            addClickBtns: function () {
                ...
                e.moreBtn.node.on(cc.Node.EventType.TOUCH_START, function () {
                    ...
                    // console.log("MoreGame",o);
                    // window.location.href = o.moreGameUrl
                    const homeUrl = "https://haiyong.site/moyu"
