var LEVELS = [
	...
	[
		...
		"  x!x                                                                                                        ",
		"  x!x                                                                                                        ",
		"  x!x        o         xxx        o        xxx        o        xxx        o        xxx                      ",
		"  x!xxxxxxxxxxxxxxxxxx!!!xxxxxxxxxxxxxxxxx!!!xxxxxxxxxxxxxxxxx!!!xxxxxxxxxxxxxxxxx!!!xxxxxxxxxxxxxxxxxx      ",
		"  x!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!x     ",
	...
	[
		...
		"                                 x!!!x                x!!x                               x!!!x               ",
		"                                 x!!!x      o         x!!x         o                     x!!!x               ",
		"                              xxxx!!!xxxx xxxxx       x!!x       xxxxx                xxxx!!!xxxx            ",
		"                              x!!!!!!!!!!x           xx!!xx           x              x!!!!!!!!!!x            ",
		"                              x!!!!!!!!!!x          xx!!!!xx          x              x!!!!!!!!!!x            ",
		"                              xxxxxxxxxxxx         xx!!!!!!xx         x              xxxxxxxxxxxx            ",
		"                                                  xx!!!!!!!!xx        x                                      ",
		"                     o                          xx!!!!!!!!!!xx       x                          o           ",
		"                  xxxxx        xxx            xx!!!!!!!!!!!!xx      x                       xxxxx          ",
		"                  x!!!x        x!x           xx!!!!!!!!!!!!!!xx     x                       x!!!x          ",
		"                  x!!!x        x!x          xx!!!!!!!!!!!!!!!!xx    x      o                x!!!x          ",
		"               xxxx!!!xxxx     x!x         xx!!!!!!!!!!!!!!!!!!xx   x   xxxxx            xxxx!!!xxxx       ",
		"               x!!!!!!!!!!x    x!x        xx!!!!!!!!!!!!!!!!!!!!xx  x   x!!!x            x!!!!!!!!!!x       ",
		"               x!!!!!!!!!!x    x!x       xx!!!!!!!!!!!!!!!!!!!!!!xx x   x!!!x            x!!!!!!!!!!x       ",
		"               xxxxxxxxxxxx    x!xxxxxxxx!!!!!!!!!!!!!!!!!!!!!!!!!!!xx   x!!!x            xxxxxxxxxxxx       ",
		"                              x!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!x   xxxxx                             ",
		"                              x!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!x                                     ",
		"           o                  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx                                     ",
		"        xxxxx                                                                              o                  ",
		"        x!!!x                    o        o        o        o        o                 xxxxx                 ",
		"        x!!!x                 xxxxx    xxxxx    xxxxx    xxxxx    xxxxx                x!!!x                 ",
		"     xxxx!!!xxxx              x!!!x    x!!!x    x!!!x    x!!!x    x!!!x             xxxx!!!xxxx              ",
		"     x!!!!!!!!!!x          xxxx!!!xxxx!!!xxxx!!!xxxx!!!xxxx!!!xxxx!!!xxxx           x!!!!!!!!!!x              ",
		"     x!!!!!!!!!!x          x!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!x           x!!!!!!!!!!x              ",
		...
		"  x!x              x!!!x                x!!!x                x!!!x                x!!!x                      ",
		"  x!xxxxxxxxx   xxxx!!!xxxx          xxxx!!!xxxx          xxxx!!!xxxx          xxxx!!!xxxx                   ",
		"  x!!!!!!!!!!!!!!!!!!!!!!!x          x!!!!!!!!!!x        x!!!!!!!!!!x        x!!!!!!!!!!x                  ",
		"  x!!!!!!!!!!!!!!!!!!!!!!!x          x!!!!!!!!!!x        x!!!!!!!!!!x        x!!!!!!!!!!xxxxxxxxxxxxxxxxx  ",
		"  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx     xxxxxxxxxxxx        xxxxxxxxxxxx        xxxxxxxxxxxxxxx!!!!!!!!!!!!!!x  ",
		"                                x                                                              x!!!!!!!!!!!!!!x  ",
		"                                x                                                              x!!!!!!!!!!!!!!x  ",
		"                                x                                              v               xxxxxxxxxxxxxxxxx  ",
