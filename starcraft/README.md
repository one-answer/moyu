 ...
 * Download the latest version from github: https://github.com/gloomyson/StarCraft/archive/master.zip
 * Unzip the folder
 * Double click `index.html` in the folder (this should open the game with your browser)
 * Press the radio button (circle next to the level name) to select a level
 * Play it online at: http://gloomyson.github.io/StarCraft/
