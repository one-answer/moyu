...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://www.akawang.xin/games/duimutou/icon.png",
		url: "http://www.akawang.xin/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注A咖游戏:akaguanwang"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://www.akawang.xin/games/duimutou/i/icon.png';
	lineLink = 'http://www.akawang.xin/games/duimutou';
