var $User = function() {
	...
	ShadowPNG = "https://haiyong.site/moyu/pvz/images/plantshadow" + ($User.Browser.IE6 ? (document.execCommand("BackgroundImageCache", false, true),
		"8.gif") : "32.png"),
	innerText = (function() {
	...
	oS = {
		...
		Init: function(e, g, b, d) {
			...
			!this.backgroundImage && (this.backgroundImage = "https://haiyong.site/moyu/pvz/images/interface/background1.jpg");
			...
			(this.Coord || function() {
				...
				!oS.InitLawnMower && (oS.InitLawnMower = function() {
					...
					while (--f) {
						h[f] = 1;
						NewImg("LawnMower" + f, "https://haiyong.site/moyu/pvz/images/LawnMower.gif", "left:" + oS.LawnMowerX + "px;top:" + (GetY(f) - 60) +
		...
		CheckImg: function(b, a) {
			...
			if (c.AccessNum == c.PicNum) {
				...
				(c.LoadAccess || function() {
					NewImg("imgGrowSoil", "https://haiyong.site/moyu/pvz/images/interface/GrowSoil.png", "display:none;z-index:50", EDAll);
	...
	oGd = {
		...
		MB1: function(e, j, m, f) {
			...
			n < 1 && f[g + "_" + c] && l != c && ((e.Kind = ++n) && (h = e.Attack = 40), e.ChangeC = c, k.src =
				"https://haiyong.site/moyu/pvz/images/Plants/PB" + n + a + ".gif");
			b && b.Altitude == 1 ? (b.getHurt(-1, a, h, n, 0, 0, 0), m.splice(j, 1), (SetStyle(k, {
					left: e.pixelLeft + 28 + "px"
				})).src = "https://haiyong.site/moyu/pvz/images/Plants/PeaBulletHit.gif", oSym.addTask(10, ClearChild, [k])) : (e.X += (p = !a ? 5 : -5)) < oS.W &&
		...
		MB2: function(d, g, h) {
			...
			b && b.Altitude == 1 ? (b.getHurt(-1, 0, 20, 0, 0, 0, 0), h.splice(g, 1), (SetStyle(e, {
				...
				})).src = "https://haiyong.site/moyu/pvz/images/Plants/ShroomBulletHit.gif", oSym.addTask(10, ClearChild, [e])) : (d.X += 5) < oS.W ? e.style.left =
	...
	ChoseShovel = function(a) {
		WhichMouseButton(a) < 2 && (SetNone($("imgShovel")), NewImg("tShovel", "https://haiyong.site/moyu/pvz/images/interface/Shovel.png", "left:" + (a.clientX -
	...
	AppearSun = function(h, f, e, a) {
		...
		NewImg(g, "https://haiyong.site/moyu/pvz/images/Sun.gif", c, EDAll, {
			onclick: function() {
				ClickSun(this.id)
			}
		});
	...
	ShowLargeWave = function(a) {
		NewImg("LargeWave", "https://haiyong.site/moyu/pvz/images/LargeWave.gif", "left:71px;top:249px;width:858px;height:102px;z-index:50", EDAll);
	...
	ShowFinalWave = function() {
		var a = function(b) {
			NewImg("FinalWave", "https://haiyong.site/moyu/pvz/images/FinalWave.gif", "left:122px;top:194px;width:756px;height:213px;z-index:50", EDAll);
	...
	GameOver = function() {
		NewImg("iGameOver", "https://haiyong.site/moyu/pvz/images/ZombiesWon.png", "width:900px;height:600px;z-index:255", EDAll, {
			onclick: function() {
				SelectModal(oS.Lvl)
			}
		})
	...
	PrepareGrowPlants = function(a) {
		NewImg("PrepareGrow", "https://haiyong.site/moyu/pvz/images/PrepareGrowPlants.gif" + $Random + Math.random(), "z-index:50;left:" + (oS.W * 0.5 - 77) +
